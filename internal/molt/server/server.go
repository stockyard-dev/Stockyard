// Package server provides the HTTP API for Stockyard Molt.
package server
...
func (s *Server) ListenAndServe() error {
	...
	log.Printf("Molt server listening on %s", addr)
