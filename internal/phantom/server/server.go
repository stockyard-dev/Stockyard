// Package server provides the HTTP API for Stockyard Phantom.
package server
...
func (s *Server) ListenAndServe() error {
	...
	log.Printf("Phantom server listening on %s", addr)
...
func (s *Server) handleHealth(w http.ResponseWriter, r *http.Request) {
	writeJSON(w, 200, map[string]any{"status": "ok", "product": "phantom"})
}
