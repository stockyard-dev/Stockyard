...
func OpenAPISpec() map[string]any {
	return map[string]any{
		...
		"info": map[string]any{
			"title":       "Stockyard API",
			"version":     "1.0.0",
			"description": "LLM gateway with 16 apps, 76 middleware modules, and 16 providers. Drop-in OpenAI-compatible proxy with observability, trust policies, A/B testing, and workflow orchestration.",
