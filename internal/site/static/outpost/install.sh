#!/bin/sh
# Stockyard Outpost installer
# Downloads the latest release from GitHub and installs to ~/.local/bin
#
# Usage:  curl -fsSL https://stockyard.dev/outpost/install.sh | sh
#         INSTALL_DIR=/usr/local/bin curl -fsSL https://stockyard.dev/outpost/install.sh | sh
set -e
