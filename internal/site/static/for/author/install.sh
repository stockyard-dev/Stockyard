...
echo ""
echo "  Stockyard for Self-Published Authors"
...
BUNDLE_DIR="$HOME/stockyard-author"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Self-Published Authors..."
echo ""
...
STOCKYARD FOR SELF-PUBLISHED AUTHORS
...
Trial:   https://stockyard.dev/pricing/?bundle=author
