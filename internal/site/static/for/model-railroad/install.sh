...
echo ""
echo "  Stockyard for Model Railroad Clubs"
...
BUNDLE_DIR="$HOME/stockyard-model-railroad"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Model Railroad Clubs..."
echo ""
...
STOCKYARD FOR MODEL RAILROAD CLUBS
...
Trial:   https://stockyard.dev/pricing/?bundle=model-railroad
