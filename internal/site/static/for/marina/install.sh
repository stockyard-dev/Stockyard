...
echo ""
echo "  Stockyard for Marinas & Boat Storage"
...
BUNDLE_DIR="$HOME/stockyard-marina"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Marinas & Boat Storage..."
echo ""
...
STOCKYARD FOR MARINAS & BOAT STORAGE
...
Trial:   https://stockyard.dev/pricing/?bundle=marina
