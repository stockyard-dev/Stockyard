...
echo ""
echo "  Stockyard for Daycare & Childcare Centers"
...
BUNDLE_DIR="$HOME/stockyard-daycare"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Daycare & Childcare Centers..."
echo ""
...
STOCKYARD FOR DAYCARE & CHILDCARE CENTERS
...
Trial:   https://stockyard.dev/pricing/?bundle=daycare
