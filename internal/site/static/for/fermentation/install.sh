...
echo "  4 tools — self-hosted on your hardware"
echo ""
...
BUNDLE_DIR="$HOME/stockyard-fermentation"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Fermenters & Kombucha Brewers..."
echo ""
...
STOCKYARD FOR FERMENTERS & KOMBUCHA BREWERS
...
Trial:   https://stockyard.dev/pricing/?bundle=fermentation
Help:    hello@stockyard.dev
READMEEOF

echo ""
if [ "$FAILED" -eq 0 ]; then
  echo "  ✓ All 4 tools installed to $BUNDLE_DIR/"
else
