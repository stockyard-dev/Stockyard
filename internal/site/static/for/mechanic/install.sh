...
echo ""
echo "  Stockyard for Mobile Mechanics"
...
BUNDLE_DIR="$HOME/stockyard-mechanic"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Mobile Mechanics..."
echo ""
...
STOCKYARD FOR MOBILE MECHANICS
...
Trial:   https://stockyard.dev/pricing/?bundle=mechanic
