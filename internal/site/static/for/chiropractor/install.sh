...
echo ""
echo "  Stockyard for Chiropractic Practices"
...
BUNDLE_DIR="$HOME/stockyard-chiropractor"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Chiropractic Practices..."
echo ""
...
STOCKYARD FOR CHIROPRACTIC PRACTICES
...
Trial:   https://stockyard.dev/pricing/?bundle=chiropractor
