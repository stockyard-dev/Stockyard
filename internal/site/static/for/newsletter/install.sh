...
echo ""
echo "  Stockyard for Newsletter Writers"
...
BUNDLE_DIR="$HOME/stockyard-newsletter"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Newsletter Writers..."
echo ""
...
STOCKYARD FOR NEWSLETTER WRITERS
...
Trial:   https://stockyard.dev/pricing/?bundle=newsletter
