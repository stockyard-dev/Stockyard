...
echo ""
echo "  Stockyard for Discord Community Managers"
...
BUNDLE_DIR="$HOME/stockyard-discord"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Discord Community Managers..."
echo ""
...
STOCKYARD FOR DISCORD COMMUNITY MANAGERS
...
Trial:   https://stockyard.dev/pricing/?bundle=discord
