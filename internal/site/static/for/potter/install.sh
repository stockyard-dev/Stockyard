...
BUNDLE_DIR="$HOME/stockyard-potter"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Potters & Ceramicists..."
echo ""
...
STOCKYARD FOR POTTERS & CERAMICISTS
...
Trial:   https://stockyard.dev/pricing/?bundle=potter
