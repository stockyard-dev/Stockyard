...
echo ""
echo "  Stockyard for Independent Pharmacies"
...
BUNDLE_DIR="$HOME/stockyard-pharmacy"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Independent Pharmacies..."
echo ""
...
STOCKYARD FOR INDEPENDENT PHARMACIES
...
Trial:   https://stockyard.dev/pricing/?bundle=pharmacy
