...
echo ""
echo "  Stockyard for Vintage & Classic Car Owners"
...
BUNDLE_DIR="$HOME/stockyard-vintage-car"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Vintage & Classic Car Owners..."
echo ""
...
STOCKYARD FOR VINTAGE & CLASSIC CAR OWNERS
...
Trial:   https://stockyard.dev/pricing/?bundle=vintage-car
