...
echo ""
echo "  Stockyard for Graphic Designers"
...
BUNDLE_DIR="$HOME/stockyard-graphic-designer"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Graphic Designers..."
echo ""
...
STOCKYARD FOR GRAPHIC DESIGNERS
...
Trial:   https://stockyard.dev/pricing/?bundle=graphic-designer
