...
BUNDLE_DIR="$HOME/stockyard-lawn-care"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Lawn Care & Landscaping..."
echo ""
...
STOCKYARD FOR LAWN CARE & LANDSCAPING
...
Trial:   https://stockyard.dev/pricing/?bundle=lawn-care
