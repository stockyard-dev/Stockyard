...
echo ""
echo "  Stockyard for Tutoring Centers"
...
BUNDLE_DIR="$HOME/stockyard-tutoring-center"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Tutoring Centers..."
echo ""
...
STOCKYARD FOR TUTORING CENTERS
...
Trial:   https://stockyard.dev/pricing/?bundle=tutoring-center
