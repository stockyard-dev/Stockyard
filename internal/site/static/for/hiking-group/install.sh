...
BUNDLE_DIR="$HOME/stockyard-hiking-group"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Hiking & Trail Groups..."
echo ""
...
STOCKYARD FOR HIKING & TRAIL GROUPS
...
Trial:   https://stockyard.dev/pricing/?bundle=hiking-group
