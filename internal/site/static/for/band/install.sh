...
echo ""
echo "  Stockyard for Bands & Music Groups"
...
BUNDLE_DIR="$HOME/stockyard-band"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Bands & Music Groups..."
echo ""
...
STOCKYARD FOR BANDS & MUSIC GROUPS
...
Trial:   https://stockyard.dev/pricing/?bundle=band
