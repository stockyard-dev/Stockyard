...
BUNDLE_DIR="$HOME/stockyard-astronomy"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Astronomy Clubs..."
echo ""
...
Trial:   https://stockyard.dev/pricing/?bundle=astronomy
