...
echo ""
echo "  Stockyard for Tabletop RPG Groups"
...
BUNDLE_DIR="$HOME/stockyard-tabletop"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Tabletop RPG Groups..."
echo ""
...
STOCKYARD FOR TABLETOP RPG GROUPS
...
Trial:   https://stockyard.dev/pricing/?bundle=tabletop
