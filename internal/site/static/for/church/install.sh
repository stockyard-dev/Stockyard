...
echo ""
echo "  Stockyard for Churches & Houses of Worship"
...
BUNDLE_DIR="$HOME/stockyard-church"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Churches & Houses of Worship..."
echo ""
...
STOCKYARD FOR CHURCHES & HOUSES OF WORSHIP
...
Trial:   https://stockyard.dev/pricing/?bundle=church
