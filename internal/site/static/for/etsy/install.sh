...
echo ""
echo "  Stockyard for Etsy & Handmade Sellers"
...
BUNDLE_DIR="$HOME/stockyard-etsy"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Etsy & Handmade Sellers..."
echo ""
...
STOCKYARD FOR ETSY & HANDMADE SELLERS
...
Trial:   https://stockyard.dev/pricing/?bundle=etsy
