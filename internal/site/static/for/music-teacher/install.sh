...
echo ""
echo "  Stockyard for Music Teachers & Studios"
...
BUNDLE_DIR="$HOME/stockyard-music-teacher"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Music Teachers & Studios..."
echo ""
...
STOCKYARD FOR MUSIC TEACHERS & STUDIOS
...
Trial:   https://stockyard.dev/pricing/?bundle=music-teacher
