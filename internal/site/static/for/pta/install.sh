...
echo ""
echo "  Stockyard for PTA / Parent-Teacher Organizations"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for PTA / Parent-Teacher Organizations..."
echo ""
...
STOCKYARD FOR PTA / PARENT-TEACHER ORGANIZATIONS
...
Trial:   https://stockyard.dev/pricing/?bundle=pta
