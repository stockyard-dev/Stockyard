...
BUNDLE_DIR="$HOME/stockyard-event-planner"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Event Planners..."
echo ""
...
Trial:   https://stockyard.dev/pricing/?bundle=event-planner
