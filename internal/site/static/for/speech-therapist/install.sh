...
BUNDLE_DIR="$HOME/stockyard-speech-therapist"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Speech Therapists..."
echo ""
...
STOCKYARD FOR SPEECH THERAPISTS
...
Trial:   https://stockyard.dev/pricing/?bundle=speech-therapist
