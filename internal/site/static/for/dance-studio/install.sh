...
echo ""
echo "  Stockyard for Dance Studios"
...
BUNDLE_DIR="$HOME/stockyard-dance-studio"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Dance Studios..."
echo ""
...
Trial:   https://stockyard.dev/pricing/?bundle=dance-studio
