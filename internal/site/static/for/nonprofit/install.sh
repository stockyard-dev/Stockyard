...
echo ""
echo "  Stockyard for Nonprofits & Charities"
...
BUNDLE_DIR="$HOME/stockyard-nonprofit"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Nonprofits & Charities..."
echo ""
...
STOCKYARD FOR NONPROFITS & CHARITIES
...
Trial:   https://stockyard.dev/pricing/?bundle=nonprofit
