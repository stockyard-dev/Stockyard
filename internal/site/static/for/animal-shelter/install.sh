...
echo ""
echo "  Stockyard for Animal Shelters & Rescue Orgs"
...
BUNDLE_DIR="$HOME/stockyard-animal-shelter"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Animal Shelters & Rescue Orgs..."
echo ""
...
STOCKYARD FOR ANIMAL SHELTERS & RESCUE ORGS
...
Trial:   https://stockyard.dev/pricing/?bundle=animal-shelter
