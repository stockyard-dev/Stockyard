...
echo ""
echo "  Stockyard for Terraria Server Admins"
...
BUNDLE_DIR="$HOME/stockyard-terraria"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Terraria Server Admins..."
echo ""
...
STOCKYARD FOR TERRARIA SERVER ADMINS
...
Trial:   https://stockyard.dev/pricing/?bundle=terraria
