...
BUNDLE_DIR="$HOME/stockyard-golf-league"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Golf Leagues..."
echo ""
...
Trial:   https://stockyard.dev/pricing/?bundle=golf-league
