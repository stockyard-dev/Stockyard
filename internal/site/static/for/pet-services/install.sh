...
echo ""
echo "  Stockyard for Dog Groomers & Pet Sitters"
...
BUNDLE_DIR="$HOME/stockyard-pet-services"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Dog Groomers & Pet Sitters..."
echo ""
...
STOCKYARD FOR DOG GROOMERS & PET SITTERS
...
Trial:   https://stockyard.dev/pricing/?bundle=pet-services
