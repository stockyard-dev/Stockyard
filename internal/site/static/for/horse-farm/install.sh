...
BUNDLE_DIR="$HOME/stockyard-horse-farm"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Horse Farms & Equine Breeders..."
echo ""
...
STOCKYARD FOR HORSE FARMS & EQUINE BREEDERS
...
Trial:   https://stockyard.dev/pricing/?bundle=horse-farm
