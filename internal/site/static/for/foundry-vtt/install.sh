...
BUNDLE_DIR="$HOME/stockyard-foundry-vtt"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Foundry VTT Hosts..."
echo ""
...
STOCKYARD FOR FOUNDRY VTT HOSTS
...
Trial:   https://stockyard.dev/pricing/?bundle=foundry-vtt
