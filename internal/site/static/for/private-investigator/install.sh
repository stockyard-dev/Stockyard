...
echo ""
echo "  Stockyard for Private Investigators"
...
BUNDLE_DIR="$HOME/stockyard-private-investigator"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Private Investigators..."
echo ""
...
STOCKYARD FOR PRIVATE INVESTIGATORS
...
Trial:   https://stockyard.dev/pricing/?bundle=private-investigator
