...
echo ""
echo "  Stockyard for Notaries & Signing Agents"
...
BUNDLE_DIR="$HOME/stockyard-notary"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Notaries & Signing Agents..."
echo ""
...
STOCKYARD FOR NOTARIES & SIGNING AGENTS
...
Trial:   https://stockyard.dev/pricing/?bundle=notary
