...
echo ""
echo "  Stockyard for Fiber Artists & Weavers"
...
BUNDLE_DIR="$HOME/stockyard-fiber-artist"
...
STOCKYARD FOR FIBER ARTISTS & WEAVERS
...
Trial:   https://stockyard.dev/pricing/?bundle=fiber-artist
