...
echo ""
echo "  Stockyard for Bowling Leagues"
...
BUNDLE_DIR="$HOME/stockyard-bowling-league"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Bowling Leagues..."
echo ""
...
Trial:   https://stockyard.dev/pricing/?bundle=bowling-league
