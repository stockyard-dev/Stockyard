...
echo ""
echo "  Stockyard for FiveM / GTA RP Server Admins"
...
BUNDLE_DIR="$HOME/stockyard-fivem"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for FiveM / GTA RP Server Admins..."
echo ""
...
STOCKYARD FOR FIVEM / GTA RP SERVER ADMINS
...
Trial:   https://stockyard.dev/pricing/?bundle=fivem
