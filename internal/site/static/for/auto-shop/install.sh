...
echo ""
echo "  Stockyard for Auto Repair Shops"
...
BUNDLE_DIR="$HOME/stockyard-auto-shop"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Auto Repair Shops..."
echo ""
...
STOCKYARD FOR AUTO REPAIR SHOPS
...
Trial:   https://stockyard.dev/pricing/?bundle=auto-shop
