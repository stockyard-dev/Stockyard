...
echo ""
echo "  ┌──────────────────────────────────────────┐"
echo "  │  Stockyard for Tutoring Services        │"
echo "  │  7 tools · $7.99/mo · self-hosted        │"
echo "  │  https://stockyard.dev/for/tutoring/     │"
echo "  └──────────────────────────────────────────┘"
echo ""
...
echo "  Free tier: 5 items per tool. Upgrade: stockyard.dev/pricing/?bundle=tutoring"
echo ""
