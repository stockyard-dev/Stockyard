...
echo ""
echo "  Stockyard for Tattoo Studios"
...
BUNDLE_DIR="$HOME/stockyard-tattoo"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Tattoo Studios..."
echo ""
...
Trial:   https://stockyard.dev/pricing/?bundle=tattoo
