...
echo ""
echo "  Stockyard for Community Gardens"
...
BUNDLE_DIR="$HOME/stockyard-community-garden"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Community Gardens..."
echo ""
...
STOCKYARD FOR COMMUNITY GARDENS
...
Trial:   https://stockyard.dev/pricing/?bundle=community-garden
