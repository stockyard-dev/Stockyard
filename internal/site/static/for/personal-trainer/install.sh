...
echo ""
echo "  Stockyard for Personal Trainers & Coaches"
...
BUNDLE_DIR="$HOME/stockyard-personal-trainer"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Personal Trainers & Coaches..."
echo ""
...
STOCKYARD FOR PERSONAL TRAINERS & COACHES
...
Trial:   https://stockyard.dev/pricing/?bundle=personal-trainer
