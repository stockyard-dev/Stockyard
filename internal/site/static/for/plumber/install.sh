...
BUNDLE_DIR="$HOME/stockyard-plumber"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Plumbers..."
echo ""
...
Trial:   https://stockyard.dev/pricing/?bundle=plumber
