...
echo ""
echo "  Stockyard for Bakeries & Pastry Shops"
...
BUNDLE_DIR="$HOME/stockyard-bakery"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Bakeries & Pastry Shops..."
echo ""
...
STOCKYARD FOR BAKERIES & PASTRY SHOPS
...
Trial:   https://stockyard.dev/pricing/?bundle=bakery
