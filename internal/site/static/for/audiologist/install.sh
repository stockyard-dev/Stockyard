...
echo ""
echo "  Stockyard for Audiologists"
...
BUNDLE_DIR="$HOME/stockyard-audiologist"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Audiologists..."
echo ""
...
Trial:   https://stockyard.dev/pricing/?bundle=audiologist
