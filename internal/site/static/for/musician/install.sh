...
echo ""
echo "  Stockyard for Independent Musicians"
...
BUNDLE_DIR="$HOME/stockyard-musician"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Independent Musicians..."
echo ""
...
STOCKYARD FOR INDEPENDENT MUSICIANS
...
Trial:   https://stockyard.dev/pricing/?bundle=musician
