...
echo ""
echo "  Stockyard for Occupational Therapists"
...
BUNDLE_DIR="$HOME/stockyard-occupational-therapy"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Occupational Therapists..."
echo ""
...
STOCKYARD FOR OCCUPATIONAL THERAPISTS
...
Trial:   https://stockyard.dev/pricing/?bundle=occupational-therapy
