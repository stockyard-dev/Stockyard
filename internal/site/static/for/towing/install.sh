...
echo ""
echo "  Stockyard for Towing Companies"
...
BUNDLE_DIR="$HOME/stockyard-towing"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Towing Companies..."
echo ""
...
STOCKYARD FOR TOWING COMPANIES
...
Trial:   https://stockyard.dev/pricing/?bundle=towing
