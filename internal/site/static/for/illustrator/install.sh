...
echo ""
echo "  Stockyard for Illustrators & Comic Artists"
...
BUNDLE_DIR="$HOME/stockyard-illustrator"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Illustrators & Comic Artists..."
echo ""
...
STOCKYARD FOR ILLUSTRATORS & COMIC ARTISTS
...
Trial:   https://stockyard.dev/pricing/?bundle=illustrator
