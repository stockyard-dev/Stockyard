...
BUNDLE_DIR="$HOME/stockyard-aquaponics"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Aquaponics & Hydroponics Growers..."
echo ""
...
STOCKYARD FOR AQUAPONICS & HYDROPONICS GROWERS
...
Trial:   https://stockyard.dev/pricing/?bundle=aquaponics
