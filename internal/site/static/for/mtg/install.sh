...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for MTG & Card Game Tournament Organizers..."
echo ""
...
STOCKYARD FOR MTG & CARD GAME TOURNAMENT ORGANIZERS
...
Trial:   https://stockyard.dev/pricing/?bundle=mtg
