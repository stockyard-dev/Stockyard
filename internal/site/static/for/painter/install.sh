...
echo ""
echo "  Stockyard for Painters & Decorators"
...
BUNDLE_DIR="$HOME/stockyard-painter"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Painters & Decorators..."
echo ""
...
STOCKYARD FOR PAINTERS & DECORATORS
...
Trial:   https://stockyard.dev/pricing/?bundle=painter
