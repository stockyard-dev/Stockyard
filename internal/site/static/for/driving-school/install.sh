...
echo ""
echo "  Stockyard for Driving Schools"
...
BUNDLE_DIR="$HOME/stockyard-driving-school"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Driving Schools..."
echo ""
...
Trial:   https://stockyard.dev/pricing/?bundle=driving-school
