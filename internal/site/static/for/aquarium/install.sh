...
BUNDLE_DIR="$HOME/stockyard-aquarium"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Aquarium & Reef Keepers..."
echo ""
...
STOCKYARD FOR AQUARIUM & REEF KEEPERS
...
Trial:   https://stockyard.dev/pricing/?bundle=aquarium
