...
echo ""
echo "  Stockyard for Garry's Mod Server Admins"
...
BUNDLE_DIR="$HOME/stockyard-gmod"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Garry's Mod Server Admins..."
echo ""
...
STOCKYARD FOR GARRY'S MOD SERVER ADMINS
...
Trial:   https://stockyard.dev/pricing/?bundle=gmod
