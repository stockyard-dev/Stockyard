...
echo ""
echo "  Stockyard for Dental Practices"
...
BUNDLE_DIR="$HOME/stockyard-dental"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Dental Practices..."
echo ""
...
STOCKYARD FOR DENTAL PRACTICES
...
Trial:   https://stockyard.dev/pricing/?bundle=dental
