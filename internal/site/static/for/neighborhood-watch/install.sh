...
echo ""
echo "  Stockyard for Neighborhood Watch"
...
BUNDLE_DIR="$HOME/stockyard-neighborhood-watch"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Neighborhood Watch..."
echo ""
...
STOCKYARD FOR NEIGHBORHOOD WATCH
...
Trial:   https://stockyard.dev/pricing/?bundle=neighborhood-watch
