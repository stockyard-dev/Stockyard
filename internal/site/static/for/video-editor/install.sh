...
echo ""
echo "  Stockyard for Video Editors & Post-Production"
...
BUNDLE_DIR="$HOME/stockyard-video-editor"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Video Editors & Post-Production..."
echo ""
...
STOCKYARD FOR VIDEO EDITORS & POST-PRODUCTION
...
Trial:   https://stockyard.dev/pricing/?bundle=video-editor
