...
echo ""
echo "  Stockyard for Landscapers"
...
BUNDLE_DIR="$HOME/stockyard-landscaper"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Landscapers..."
echo ""
...
Trial:   https://stockyard.dev/pricing/?bundle=landscaper
