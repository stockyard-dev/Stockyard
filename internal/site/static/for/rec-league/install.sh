...
echo ""
echo "  Stockyard for Recreational Sports Leagues"
...
BUNDLE_DIR="$HOME/stockyard-rec-league"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Recreational Sports Leagues..."
echo ""
...
STOCKYARD FOR RECREATIONAL SPORTS LEAGUES
...
Trial:   https://stockyard.dev/pricing/?bundle=rec-league
