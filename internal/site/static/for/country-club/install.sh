...
echo ""
echo "  Stockyard for Country Clubs"
...
BUNDLE_DIR="$HOME/stockyard-country-club"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Country Clubs..."
echo ""
...
Trial:   https://stockyard.dev/pricing/?bundle=country-club
