...
echo ""
echo "  Stockyard for Pickleball Clubs & Leagues"
...
BUNDLE_DIR="$HOME/stockyard-pickleball"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Pickleball Clubs & Leagues..."
echo ""
...
STOCKYARD FOR PICKLEBALL CLUBS & LEAGUES
...
Trial:   https://stockyard.dev/pricing/?bundle=pickleball
