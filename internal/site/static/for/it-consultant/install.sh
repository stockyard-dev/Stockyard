...
echo ""
echo "  Stockyard for IT Consultants"
...
BUNDLE_DIR="$HOME/stockyard-it-consultant"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for IT Consultants..."
echo ""
...
Trial:   https://stockyard.dev/pricing/?bundle=it-consultant
