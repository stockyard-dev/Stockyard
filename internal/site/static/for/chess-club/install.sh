...
echo ""
echo "  Stockyard for Chess Clubs"
...
BUNDLE_DIR="$HOME/stockyard-chess-club"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Chess Clubs..."
echo ""
...
Trial:   https://stockyard.dev/pricing/?bundle=chess-club
