...
BUNDLE_DIR="$HOME/stockyard-soap-maker"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Soap & Candle Makers..."
echo ""
...
STOCKYARD FOR SOAP & CANDLE MAKERS
...
Trial:   https://stockyard.dev/pricing/?bundle=soap-maker
