...
echo ""
echo "  Stockyard for 3D Printing Enthusiasts"
...
BUNDLE_DIR="$HOME/stockyard-3d-printing"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for 3D Printing Enthusiasts..."
echo ""
...
STOCKYARD FOR 3D PRINTING ENTHUSIASTS
...
Trial:   https://stockyard.dev/pricing/?bundle=3d-printing
