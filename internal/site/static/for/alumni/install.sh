...
echo ""
echo "  Stockyard for Alumni Associations"
...
BUNDLE_DIR="$HOME/stockyard-alumni"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Alumni Associations..."
echo ""
...
STOCKYARD FOR ALUMNI ASSOCIATIONS
...
Trial:   https://stockyard.dev/pricing/?bundle=alumni
