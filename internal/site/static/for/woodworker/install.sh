...
BUNDLE_DIR="$HOME/stockyard-woodworker"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Woodworkers..."
echo ""
...
Trial:   https://stockyard.dev/pricing/?bundle=woodworker
