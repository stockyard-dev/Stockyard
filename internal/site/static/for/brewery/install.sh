...
echo ""
echo "  Stockyard for Breweries & Distilleries"
...
BUNDLE_DIR="$HOME/stockyard-brewery"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Breweries & Distilleries..."
echo ""
...
STOCKYARD FOR BREWERIES & DISTILLERIES
...
Trial:   https://stockyard.dev/pricing/?bundle=brewery
