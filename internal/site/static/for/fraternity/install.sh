...
echo ""
echo "  Stockyard for Fraternities & Sororities"
...
BUNDLE_DIR="$HOME/stockyard-fraternity"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Fraternities & Sororities..."
echo ""
...
STOCKYARD FOR FRATERNITIES & SORORITIES
...
Trial:   https://stockyard.dev/pricing/?bundle=fraternity
