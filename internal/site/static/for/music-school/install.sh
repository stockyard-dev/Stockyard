...
BUNDLE_DIR="$HOME/stockyard-music-school"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Music Schools..."
echo ""
...
Trial:   https://stockyard.dev/pricing/?bundle=music-school
