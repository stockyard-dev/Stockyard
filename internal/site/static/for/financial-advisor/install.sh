...
echo ""
echo "  Stockyard for Financial Advisors"
...
BUNDLE_DIR="$HOME/stockyard-financial-advisor"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Financial Advisors..."
echo ""
...
STOCKYARD FOR FINANCIAL ADVISORS
...
Trial:   https://stockyard.dev/pricing/?bundle=financial-advisor
