...
BUNDLE_DIR="$HOME/stockyard-coworking"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Coworking Spaces..."
echo ""
...
STOCKYARD FOR COWORKING SPACES
...
Trial:   https://stockyard.dev/pricing/?bundle=coworking
