...
echo ""
echo "  Stockyard for Pet Groomers"
...
BUNDLE_DIR="$HOME/stockyard-pet-groomer"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Pet Groomers..."
echo ""
...
Trial:   https://stockyard.dev/pricing/?bundle=pet-groomer
