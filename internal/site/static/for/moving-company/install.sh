...
echo ""
echo "  Stockyard for Moving Companies"
...
BUNDLE_DIR="$HOME/stockyard-moving-company"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Moving Companies..."
echo ""
...
STOCKYARD FOR MOVING COMPANIES
...
Trial:   https://stockyard.dev/pricing/?bundle=moving-company
