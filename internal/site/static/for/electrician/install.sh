...
echo ""
echo "  Stockyard for Electricians & Plumbers"
...
BUNDLE_DIR="$HOME/stockyard-electrician"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Electricians & Plumbers..."
echo ""
...
STOCKYARD FOR ELECTRICIANS & PLUMBERS
...
Trial:   https://stockyard.dev/pricing/?bundle=electrician
