...
echo ""
echo "  Stockyard for Therapists & Counselors"
...
BUNDLE_DIR="$HOME/stockyard-therapist"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Therapists & Counselors..."
echo ""
...
STOCKYARD FOR THERAPISTS & COUNSELORS
...
Trial:   https://stockyard.dev/pricing/?bundle=therapist
