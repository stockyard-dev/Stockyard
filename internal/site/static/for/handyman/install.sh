...
echo ""
echo "  Stockyard for Handyman Services"
...
BUNDLE_DIR="$HOME/stockyard-handyman"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Handyman Services..."
echo ""
...
STOCKYARD FOR HANDYMAN SERVICES
...
Trial:   https://stockyard.dev/pricing/?bundle=handyman
