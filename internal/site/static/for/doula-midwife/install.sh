...
BUNDLE_DIR="$HOME/stockyard-doula-midwife"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Doulas & Midwives..."
echo ""
...
Trial:   https://stockyard.dev/pricing/?bundle=doula-midwife
