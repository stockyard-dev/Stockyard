...
echo ""
echo "  Stockyard for Tennis Clubs"
...
BUNDLE_DIR="$HOME/stockyard-tennis-club"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Tennis Clubs..."
echo ""
...
Trial:   https://stockyard.dev/pricing/?bundle=tennis-club
