...
echo ""
echo "  Stockyard for Gyms & Fitness Studios"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Gyms & Fitness Studios..."
echo ""
...
STOCKYARD FOR GYMS & FITNESS STUDIOS
...
Trial:   https://stockyard.dev/pricing/?bundle=gym
