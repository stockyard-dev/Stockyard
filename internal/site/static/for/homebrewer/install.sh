...
echo ""
echo "  Stockyard for Homebrewers"
...
BUNDLE_DIR="$HOME/stockyard-homebrewer"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Homebrewers..."
echo ""
...
Trial:   https://stockyard.dev/pricing/?bundle=homebrewer
