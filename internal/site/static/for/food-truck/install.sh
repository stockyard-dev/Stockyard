...
BUNDLE_DIR="$HOME/stockyard-food-truck"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Food Trucks..."
echo ""
...
Trial:   https://stockyard.dev/pricing/?bundle=food-truck
