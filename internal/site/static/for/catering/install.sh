...
echo ""
echo "  Stockyard for Catering Companies"
...
BUNDLE_DIR="$HOME/stockyard-catering"
...
STOCKYARD FOR CATERING COMPANIES
...
Trial:   https://stockyard.dev/pricing/?bundle=catering
