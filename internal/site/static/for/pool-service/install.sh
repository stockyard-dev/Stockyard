...
echo ""
echo "  Stockyard for Pool Service Companies"
...
BUNDLE_DIR="$HOME/stockyard-pool-service"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Pool Service Companies..."
echo ""
...
STOCKYARD FOR POOL SERVICE COMPANIES
...
Trial:   https://stockyard.dev/pricing/?bundle=pool-service
