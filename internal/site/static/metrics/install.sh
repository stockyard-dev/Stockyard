#!/bin/sh
# Stockyard Metrics installer
# Downloads the latest release from GitHub and installs to ~/.local/bin
#
# Usage:  curl -fsSL https://stockyard.dev/metrics/install.sh | sh
#         INSTALL_DIR=/usr/local/bin curl -fsSL https://stockyard.dev/metrics/install.sh | sh
set -e
