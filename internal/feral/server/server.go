// Package server provides the HTTP API for Stockyard Feral.
package server
...
func (s *Server) ListenAndServe() error {
	...
	log.Printf("Feral server listening on %s", addr)
...
func (s *Server) handleHealth(w http.ResponseWriter, r *http.Request) {
	writeJSON(w, 200, map[string]any{"status": "ok", "product": "feral"})
}
