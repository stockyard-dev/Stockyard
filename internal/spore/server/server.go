// Package server provides the HTTP API for Stockyard Spore.
package server
...
func (s *Server) ListenAndServe() error {
	...
	log.Printf("Spore server listening on %s", addr)
...
func (s *Server) handleHealth(w http.ResponseWriter, r *http.Request) {
	writeJSON(w, 200, map[string]any{"status": "ok", "product": "spore"})
}
