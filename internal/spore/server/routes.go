...
func (s *Server) routes() {
	...
	s.mux.HandleFunc("GET /api/retirement", s.handleRetirementPolicy)
	s.mux.HandleFunc("POST /api/retirement/run", s.handleRunRetirement)
	s.mux.HandleFunc("POST /api/retirement/bulk", s.handleBulkRetire)
