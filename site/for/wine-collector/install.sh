...
BUNDLE_DIR="$HOME/stockyard-wine-collector"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Wine Collectors..."
echo ""
...
Trial:   https://stockyard.dev/pricing/?bundle=wine-collector
