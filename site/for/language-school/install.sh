...
echo ""
echo "  Stockyard for Language Schools"
...
BUNDLE_DIR="$HOME/stockyard-language-school"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Language Schools..."
echo ""
...
STOCKYARD FOR LANGUAGE SCHOOLS
...
Trial:   https://stockyard.dev/pricing/?bundle=language-school
