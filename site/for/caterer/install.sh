...
echo ""
echo "  Stockyard for Independent Caterers"
...
BUNDLE_DIR="$HOME/stockyard-caterer"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Independent Caterers..."
echo ""
...
STOCKYARD FOR INDEPENDENT CATERERS
...
Trial:   https://stockyard.dev/pricing/?bundle=caterer
