...
echo ""
echo "  Stockyard for Scout Troops & Youth Groups"
...
BUNDLE_DIR="$HOME/stockyard-scouting"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Scout Troops & Youth Groups..."
echo ""
...
STOCKYARD FOR SCOUT TROOPS & YOUTH GROUPS
...
Trial:   https://stockyard.dev/pricing/?bundle=scouting
