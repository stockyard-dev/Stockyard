...
echo ""
echo "  Stockyard for Swim Teams & Swim Clubs"
...
BUNDLE_DIR="$HOME/stockyard-swim-team"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Swim Teams & Swim Clubs..."
echo ""
...
STOCKYARD FOR SWIM TEAMS & SWIM CLUBS
...
Trial:   https://stockyard.dev/pricing/?bundle=swim-team
