...
echo ""
echo "  Stockyard for Immigration Consultants"
...
BUNDLE_DIR="$HOME/stockyard-immigration-consultant"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Immigration Consultants..."
echo ""
...
STOCKYARD FOR IMMIGRATION CONSULTANTS
...
Trial:   https://stockyard.dev/pricing/?bundle=immigration-consultant
