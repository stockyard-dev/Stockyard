...
BUNDLE_DIR="$HOME/stockyard-plex"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Plex & Media Server Owners..."
echo ""
...
STOCKYARD FOR PLEX & MEDIA SERVER OWNERS
...
Trial:   https://stockyard.dev/pricing/?bundle=plex
