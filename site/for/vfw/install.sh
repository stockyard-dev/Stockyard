...
echo ""
echo "  Stockyard for VFW & American Legion Posts"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for VFW & American Legion Posts..."
echo ""
...
STOCKYARD FOR VFW & AMERICAN LEGION POSTS
...
Trial:   https://stockyard.dev/pricing/?bundle=vfw
