...
echo ""
echo "  Stockyard for Cleaning Services"
...
BUNDLE_DIR="$HOME/stockyard-cleaning-service"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Cleaning Services..."
echo ""
...
STOCKYARD FOR CLEANING SERVICES
...
Trial:   https://stockyard.dev/pricing/?bundle=cleaning-service
