...
BUNDLE_DIR="$HOME/stockyard-cycling-club"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Cycling Clubs..."
echo ""
...
Trial:   https://stockyard.dev/pricing/?bundle=cycling-club
