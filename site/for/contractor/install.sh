...
BUNDLE_DIR="$HOME/stockyard-contractor"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for General Contractors..."
echo ""
...
STOCKYARD FOR GENERAL CONTRACTORS
...
Trial:   https://stockyard.dev/pricing/?bundle=contractor
