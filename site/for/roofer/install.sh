...
echo ""
echo "  Stockyard for Roofing Companies"
...
BUNDLE_DIR="$HOME/stockyard-roofer"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Roofing Companies..."
echo ""
...
STOCKYARD FOR ROOFING COMPANIES
...
Trial:   https://stockyard.dev/pricing/?bundle=roofer
