...
BUNDLE_DIR="$HOME/stockyard-accountant-tax"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Tax Preparers..."
echo ""
...
Trial:   https://stockyard.dev/pricing/?bundle=accountant-tax
