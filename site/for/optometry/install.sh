...
echo ""
echo "  Stockyard for Optometry Practices"
...
BUNDLE_DIR="$HOME/stockyard-optometry"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Optometry Practices..."
echo ""
...
STOCKYARD FOR OPTOMETRY PRACTICES
...
Trial:   https://stockyard.dev/pricing/?bundle=optometry
