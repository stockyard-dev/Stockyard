...
echo ""
echo "  Stockyard for Rotary & Lions Clubs"
...
BUNDLE_DIR="$HOME/stockyard-rotary"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Rotary & Lions Clubs..."
echo ""
...
STOCKYARD FOR ROTARY & LIONS CLUBS
...
Trial:   https://stockyard.dev/pricing/?bundle=rotary
