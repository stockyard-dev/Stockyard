...
echo ""
echo "  Stockyard for Barber Shops & Hair Salons"
...
BUNDLE_DIR="$HOME/stockyard-barber-salon"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Barber Shops & Hair Salons..."
echo ""
...
STOCKYARD FOR BARBER SHOPS & HAIR SALONS
...
Trial:   https://stockyard.dev/pricing/?bundle=barber-salon
