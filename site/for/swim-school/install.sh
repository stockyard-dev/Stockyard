...
BUNDLE_DIR="$HOME/stockyard-swim-school"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Swim Schools & Lessons..."
echo ""
...
STOCKYARD FOR SWIM SCHOOLS & LESSONS
...
Trial:   https://stockyard.dev/pricing/?bundle=swim-school
