...
BUNDLE_DIR="$HOME/stockyard-property-manager"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Property Managers..."
echo ""
...
STOCKYARD FOR PROPERTY MANAGERS
...
Trial:   https://stockyard.dev/pricing/?bundle=property-manager
