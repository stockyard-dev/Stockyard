...
echo ""
echo "  Stockyard for Theater & Performing Arts"
...
BUNDLE_DIR="$HOME/stockyard-theater"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Theater & Performing Arts..."
echo ""
...
STOCKYARD FOR THEATER & PERFORMING ARTS
...
Trial:   https://stockyard.dev/pricing/?bundle=theater
