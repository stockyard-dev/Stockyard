...
echo ""
echo "  Stockyard for Pest Control Companies"
...
BUNDLE_DIR="$HOME/stockyard-pest-control"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Pest Control Companies..."
echo ""
...
STOCKYARD FOR PEST CONTROL COMPANIES
...
Trial:   https://stockyard.dev/pricing/?bundle=pest-control
