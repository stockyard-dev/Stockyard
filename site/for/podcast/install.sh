...
BUNDLE_DIR="$HOME/stockyard-podcast"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Podcasters..."
echo ""
...
Trial:   https://stockyard.dev/pricing/?bundle=podcast
