...
echo ""
echo "  Stockyard for Acupuncture & Traditional Medicine"
...
BUNDLE_DIR="$HOME/stockyard-acupuncture"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Acupuncture & Traditional Medicine..."
echo ""
...
STOCKYARD FOR ACUPUNCTURE & TRADITIONAL MEDICINE
...
Trial:   https://stockyard.dev/pricing/?bundle=acupuncture
