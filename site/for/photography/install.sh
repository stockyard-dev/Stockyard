...
BUNDLE_DIR="$HOME/stockyard-photography"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Photographers..."
echo ""
...
Trial:   https://stockyard.dev/pricing/?bundle=photography
