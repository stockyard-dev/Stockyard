...
echo ""
echo "  Stockyard for Car Clubs & Car Meets"
...
BUNDLE_DIR="$HOME/stockyard-car-club"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Car Clubs & Car Meets..."
echo ""
...
STOCKYARD FOR CAR CLUBS & CAR MEETS
...
Trial:   https://stockyard.dev/pricing/?bundle=car-club
