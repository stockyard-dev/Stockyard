...
echo ""
echo "  Stockyard for Sports League Organizers"
...
BUNDLE_DIR="$HOME/stockyard-sports-league"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Sports League Organizers..."
echo ""
...
STOCKYARD FOR SPORTS LEAGUE ORGANIZERS
...
Trial:   https://stockyard.dev/pricing/?bundle=sports-league
