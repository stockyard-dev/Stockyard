...
echo ""
echo "  Stockyard for After-School Programs"
...
BUNDLE_DIR="$HOME/stockyard-afterschool"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for After-School Programs..."
echo ""
...
STOCKYARD FOR AFTER-SCHOOL PROGRAMS
...
Trial:   https://stockyard.dev/pricing/?bundle=afterschool
