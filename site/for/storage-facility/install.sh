...
echo ""
echo "  Stockyard for Storage Facility Operators"
...
BUNDLE_DIR="$HOME/stockyard-storage-facility"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Storage Facility Operators..."
echo ""
...
STOCKYARD FOR STORAGE FACILITY OPERATORS
...
Trial:   https://stockyard.dev/pricing/?bundle=storage-facility
