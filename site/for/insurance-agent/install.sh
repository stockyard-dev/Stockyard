...
echo ""
echo "  Stockyard for Insurance Agents"
...
BUNDLE_DIR="$HOME/stockyard-insurance-agent"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Insurance Agents..."
echo ""
...
STOCKYARD FOR INSURANCE AGENTS
...
Trial:   https://stockyard.dev/pricing/?bundle=insurance-agent
