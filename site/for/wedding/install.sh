...
echo ""
echo "  Stockyard for Wedding Planners"
...
BUNDLE_DIR="$HOME/stockyard-wedding"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Wedding Planners..."
echo ""
...
STOCKYARD FOR WEDDING PLANNERS
...
Trial:   https://stockyard.dev/pricing/?bundle=wedding
