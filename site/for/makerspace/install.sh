...
echo ""
echo "  Stockyard for Makerspaces & Community Workshops"
echo "  12 tools — self-hosted on your hardware"
echo ""
...
BUNDLE_DIR="$HOME/stockyard-makerspace"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Makerspaces & Community Workshops..."
echo ""
...
STOCKYARD FOR MAKERSPACES & COMMUNITY WORKSHOPS
...
Trial:   https://stockyard.dev/pricing/?bundle=makerspace
Help:    hello@stockyard.dev
READMEEOF

echo ""
if [ "$FAILED" -eq 0 ]; then
  echo "  ✓ All 12 tools installed to $BUNDLE_DIR/"
else
