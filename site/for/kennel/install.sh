...
echo ""
echo "  Stockyard for Boarding Kennels"
...
BUNDLE_DIR="$HOME/stockyard-kennel"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Boarding Kennels..."
echo ""
...
STOCKYARD FOR BOARDING KENNELS
...
Trial:   https://stockyard.dev/pricing/?bundle=kennel
