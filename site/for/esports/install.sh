...
BUNDLE_DIR="$HOME/stockyard-esports"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Esports Teams & Organizers..."
echo ""
...
STOCKYARD FOR ESPORTS TEAMS & ORGANIZERS
...
Trial:   https://stockyard.dev/pricing/?bundle=esports
