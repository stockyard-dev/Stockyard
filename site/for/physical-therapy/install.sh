...
echo ""
echo "  Stockyard for Physical Therapy Practices"
echo "  10 tools — self-hosted on your hardware"
echo ""
...
BUNDLE_DIR="$HOME/stockyard-physical-therapy"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Physical Therapy Practices..."
echo ""
...
STOCKYARD FOR PHYSICAL THERAPY PRACTICES
...
Trial:   https://stockyard.dev/pricing/?bundle=physical-therapy
Help:    hello@stockyard.dev
READMEEOF

echo ""
if [ "$FAILED" -eq 0 ]; then
  echo "  ✓ All 10 tools installed to $BUNDLE_DIR/"
else
