...
echo ""
echo "  Stockyard for Translators & Interpreters"
...
BUNDLE_DIR="$HOME/stockyard-translator"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Translators & Interpreters..."
echo ""
...
STOCKYARD FOR TRANSLATORS & INTERPRETERS
...
Trial:   https://stockyard.dev/pricing/?bundle=translator
