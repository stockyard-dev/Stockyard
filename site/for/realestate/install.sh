...
echo ""
echo "  Stockyard for Real Estate Agents"
...
BUNDLE_DIR="$HOME/stockyard-realestate"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Real Estate Agents..."
echo ""
...
STOCKYARD FOR REAL ESTATE AGENTS
...
Trial:   https://stockyard.dev/pricing/?bundle=realestate
