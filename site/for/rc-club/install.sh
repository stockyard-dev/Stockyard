...
echo ""
echo "  Stockyard for RC & Drone Clubs"
...
BUNDLE_DIR="$HOME/stockyard-rc-club"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for RC & Drone Clubs..."
echo ""
...
Trial:   https://stockyard.dev/pricing/?bundle=rc-club
