...
echo ""
echo "  Stockyard for Online Course Creators"
...
BUNDLE_DIR="$HOME/stockyard-course-creator"
...
STOCKYARD FOR ONLINE COURSE CREATORS
...
Trial:   https://stockyard.dev/pricing/?bundle=course-creator
