...
echo ""
echo "  Stockyard for Campgrounds & RV Parks"
...
BUNDLE_DIR="$HOME/stockyard-campground"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Campgrounds & RV Parks..."
echo ""
...
STOCKYARD FOR CAMPGROUNDS & RV PARKS
...
Trial:   https://stockyard.dev/pricing/?bundle=campground
