...
BUNDLE_DIR="$HOME/stockyard-swim-club"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Community Swimming Pools..."
echo ""
...
STOCKYARD FOR COMMUNITY SWIMMING POOLS
...
Trial:   https://stockyard.dev/pricing/?bundle=swim-club
