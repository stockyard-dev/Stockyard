...
echo ""
echo "  Stockyard for Tailors & Alterations"
...
BUNDLE_DIR="$HOME/stockyard-tailor"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Tailors & Alterations..."
echo ""
...
STOCKYARD FOR TAILORS & ALTERATIONS
...
Trial:   https://stockyard.dev/pricing/?bundle=tailor
