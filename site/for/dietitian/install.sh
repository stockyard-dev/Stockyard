...
echo ""
echo "  Stockyard for Dietitians & Nutritionists"
...
BUNDLE_DIR="$HOME/stockyard-dietitian"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Dietitians & Nutritionists..."
echo ""
...
STOCKYARD FOR DIETITIANS & NUTRITIONISTS
...
Trial:   https://stockyard.dev/pricing/?bundle=dietitian
