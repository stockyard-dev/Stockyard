...
BUNDLE_DIR="$HOME/stockyard-nutritionist"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Nutritionists & Dietitians..."
echo ""
...
STOCKYARD FOR NUTRITIONISTS & DIETITIANS
...
Trial:   https://stockyard.dev/pricing/?bundle=nutritionist
