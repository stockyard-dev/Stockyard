...
echo ""
echo "  Stockyard for Freelancers & Solopreneurs"
...
BUNDLE_DIR="$HOME/stockyard-freelancer"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Freelancers & Solopreneurs..."
echo ""
...
STOCKYARD FOR FREELANCERS & SOLOPRENEURS
...
Trial:   https://stockyard.dev/pricing/?bundle=freelancer
