...
echo ""
echo "  Stockyard for Jewelers & Custom Jewelry"
...
BUNDLE_DIR="$HOME/stockyard-jeweler"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Jewelers & Custom Jewelry..."
echo ""
...
STOCKYARD FOR JEWELERS & CUSTOM JEWELRY
...
Trial:   https://stockyard.dev/pricing/?bundle=jeweler
