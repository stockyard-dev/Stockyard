...
echo ""
echo "  Stockyard for Home Inspectors"
...
BUNDLE_DIR="$HOME/stockyard-home-inspector"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Home Inspectors..."
echo ""
...
Trial:   https://stockyard.dev/pricing/?bundle=home-inspector
