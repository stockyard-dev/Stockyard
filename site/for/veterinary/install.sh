...
BUNDLE_DIR="$HOME/stockyard-veterinary"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Veterinary Practices..."
echo ""
...
STOCKYARD FOR VETERINARY PRACTICES
...
Trial:   https://stockyard.dev/pricing/?bundle=veterinary
