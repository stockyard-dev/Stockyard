...
echo ""
echo "  Stockyard for Twitch Streamers & Content Creators"
...
BUNDLE_DIR="$HOME/stockyard-twitch"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Twitch Streamers & Content Creators..."
echo ""
...
STOCKYARD FOR TWITCH STREAMERS & CONTENT CREATORS
...
Trial:   https://stockyard.dev/pricing/?bundle=twitch
