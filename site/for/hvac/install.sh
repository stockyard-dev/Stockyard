...
echo ""
echo "  Stockyard for HVAC Technicians"
...
BUNDLE_DIR="$HOME/stockyard-hvac"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for HVAC Technicians..."
echo ""
...
STOCKYARD FOR HVAC TECHNICIANS
...
Trial:   https://stockyard.dev/pricing/?bundle=hvac
