...
echo ""
echo "  Stockyard for Print Shops & Sign Shops"
...
BUNDLE_DIR="$HOME/stockyard-print-shop"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Print Shops & Sign Shops..."
echo ""
...
STOCKYARD FOR PRINT SHOPS & SIGN SHOPS
...
Trial:   https://stockyard.dev/pricing/?bundle=print-shop
