...
echo ""
echo "  Stockyard for Dog Breeders"
...
BUNDLE_DIR="$HOME/stockyard-dog-breeder"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Dog Breeders..."
echo ""
mkdir -p "$DATA/breeding" && PORT=9803 "$DIR/tools/stockyard-breeding" -port 9803 -data "$DATA/breeding" >/dev/null 2>&1 &
...
Trial:   https://stockyard.dev/pricing/?bundle=dog-breeder
