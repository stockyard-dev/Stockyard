...
echo ""
echo "  Stockyard for Dog Walkers & Pet Sitters"
...
BUNDLE_DIR="$HOME/stockyard-dog-walker"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Dog Walkers & Pet Sitters..."
echo ""
...
STOCKYARD FOR DOG WALKERS & PET SITTERS
...
Trial:   https://stockyard.dev/pricing/?bundle=dog-walker
