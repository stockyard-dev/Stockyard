...
BUNDLE_DIR="$HOME/stockyard-florist"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Florists..."
echo ""
...
Trial:   https://stockyard.dev/pricing/?bundle=florist
