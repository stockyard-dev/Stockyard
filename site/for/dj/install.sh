...
echo ""
echo "  Stockyard for DJs & Event Music"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for DJs & Event Music..."
echo ""
...
Trial:   https://stockyard.dev/pricing/?bundle=dj
