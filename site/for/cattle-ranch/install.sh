...
BUNDLE_DIR="$HOME/stockyard-cattle-ranch"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Cattle Ranchers..."
echo ""
...
Trial:   https://stockyard.dev/pricing/?bundle=cattle-ranch
