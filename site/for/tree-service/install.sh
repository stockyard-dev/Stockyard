...
BUNDLE_DIR="$HOME/stockyard-tree-service"
...
mkdir -p "$DATA"
echo ""
echo "  Starting Stockyard for Tree Service & Arborists..."
echo ""
...
STOCKYARD FOR TREE SERVICE & ARBORISTS
...
Trial:   https://stockyard.dev/pricing/?bundle=tree-service
