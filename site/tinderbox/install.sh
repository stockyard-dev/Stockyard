#!/bin/sh
# Stockyard Tinderbox installer
# Downloads the latest release from GitHub and installs to ~/.local/bin
#
# Usage:  curl -fsSL https://stockyard.dev/tinderbox/install.sh | sh
#         INSTALL_DIR=/usr/local/bin curl -fsSL https://stockyard.dev/tinderbox/install.sh | sh
set -e
