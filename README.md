...
- **mailer: use cached bundle title and wire cancellation email** (2026-04-09)
- **prewarm: add --force flag to skip cache layers and regenerate** (2026-04-09)
- **prewarm: fix install script cache lookup + add cmd/prewarm binary** (2026-04-09)
- **recommend: per-IP rate limit + L3 timeout/latency instrumentation** (2026-04-09)
- **recommend: Haiku 4.5 default, Sonnet 4 fallback on weak output** (2026-04-09)
- **site: route static bundle install.sh through the generator** (2026-04-09)
- **mailer: rewrite license/trial/cancellation emails for non-dev buyers** (2026-04-08)
- **dashboard: fix card-stack clipping and tab-bar overflow at narrow viewports** (2026-04-08)
- **site: standardize tool count (150+) and bundle count (200) across copy** (2026-04-08)
- **dashboard: card-stack data tables at narrow viewports** (2026-04-08)
- **site/about: replace em dash with period in licensing paragraph** (2026-04-08)
- **site: drop stale runtime handlers for routes whose backing files were gutted** (2026-04-08)
- **apiserver: rewrite Plans() to return real two-plan model** (2026-04-08)
- **site/about: targeted edits for small-business audience** (2026-04-08)
- **site: restore tools/catalog.json — fixes AI toolkit builder** (2026-04-08)
- **dashboard: add mobile nav drawer for narrow viewports** (2026-04-08)
- **site: rewrite bundle install copy for non-dev audience** (2026-04-08)
