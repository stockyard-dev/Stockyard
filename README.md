...
- **fix: pricing page checkout buttons** (2026-04-06)
- **fix: homepage install-methods broken grid — Terminal div not closed** (2026-04-06)
- **fix: add one-click download to homepage AI toolkit results** (2026-04-06)
- **fix: add install buttons + one-click download to AI-generated bundle pages** (2026-04-06)
- **fix: last stale 'free tier' refs on /complete/ and /billing/cancel/** (2026-04-06)
- **fix: enrich bundles-search.json with full tool objects** (2026-04-06)
- **fix: make /api/bundle/{slug} public for launcher access** (2026-04-06)
- **feat: add one-click download buttons to homepage bundle results** (2026-04-06)
- **feat: one-click launcher + download buttons on all bundle pages** (2026-04-06)
- **fix: AI button broken on mobile (and desktop)** (2026-04-06)
